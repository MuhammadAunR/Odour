  ...
  return (
    <>
      <a
        ...
        target="_blank"
        className="fixed left-7 bottom-7 z-90 flex items-center justify-center gap-5">
        <span
          className="group bg-surface/30 backdrop-blur-sm text-foreground border border-muted/50 p-2 rounded-full w-12 h-12 flex items-center justify-center hover:w-40 transition-all ease-linear duration-300 overflow-hidden relative"
          style={{
            animation: 'whatsappButtonAnimation 1.5s ease-out infinite',
          }}
        >
          ...
          <span className="ml-7 text-sm font-semibold whitespace-nowrap scale-0 group-hover:scale-100 transition-all duration-500">
            Whatsapp Us
          </span>
        </span>
      </a>
